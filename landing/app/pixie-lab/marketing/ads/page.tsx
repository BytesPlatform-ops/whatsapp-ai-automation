...
export const metadata: Metadata = { title: 'Meta Ads — Pixie Lab', robots: { index: false, follow: false } };
...
export default async function MarketingAdsPage() {
  ...
  return <MarketingWorkspace tab="ads" tenant={tenantForMembership(guard.membership)} />;
}
