...
export const metadata: Metadata = { title: 'SEO Competitors — Pixie Lab', robots: { index: false, follow: false } };
export const dynamic = 'force-dynamic';

export default async function SeoCompetitorsPage({ searchParams }: { searchParams: { site_id?: string } }) {
