...
export const metadata: Metadata = { title: 'Technical SEO Issues — Pixie Lab', robots: { index: false, follow: false } };
export const dynamic = 'force-dynamic';

export default async function SeoIssuesPage({
  searchParams,
}: {
  searchParams: { site_id?: string; crawl_job_id?: string; severity?: string };
}) {
