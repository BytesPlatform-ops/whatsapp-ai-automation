...
export const metadata: Metadata = { title: 'Backlinks — Pixie Lab SEO', robots: { index: false, follow: false } };
export const dynamic = 'force-dynamic';

export default async function SeoBacklinksPage({ searchParams }: { searchParams: Promise<{ site_id?: string }> }) {
