/**
 * Country dial codes for the Join Pixie contact field. One entry per country/
 * territory: ISO 3166-1 alpha-2 `iso` (also used to render the flag emoji) and
 * the E.164 `dial` prefix. Kept as plain data so the phone field can search by
 * country name or dial code. Sorted alphabetically by name.
 */
...
/** Sensible default selection for the phone field. */
