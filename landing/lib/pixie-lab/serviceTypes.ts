...
/** Marketing Brain — personalized recommendations + enriched brand view. */
...
export interface MarketingRecommendation {
  ...
  target_tab: string;
  status: string;
  draft?: { campaign_name?: string; objective?: string; status?: string; angle?: string } & Record<string, unknown>;
}
export interface MarketingBrandView {
  data_source?: string;
  generated_at?: string;
  ...
  posting_suggestions?: string[];
  ad_angles?: string[];
  retargeting_angles?: string[];
  local_awareness_angles?: string[];
  missing_data_warnings?: string[];
  stats?: BrandBrainStats;
  // Rich Brand Brain (Part 2) — present when generated by the strategist.
  ...
  brand_tone?: string;
  offer_angles?: string[];
  trust_building_angles?: string[];
  lead_generation_angles?: string[];
...
/** Business profile / onboarding brief (marketing:business_profile). */
export interface ProfileQuestion { id: string; question: string; kind: 'text' | 'single' | 'multi'; options?: string[] }
...
export interface MarketingAnalysisState {
  ...
  brand_data_source?: string;
}
export interface MarketingAnalyzeResult {
  status?: string;
  summary?: string;
  connected?: boolean;
  mode?: string | null;
  recommendations?: MarketingRecommendation[];
  brand?: MarketingBrandView;
  analysis_state?: MarketingAnalysisState;
  message?: string;
}
