...
function generateContactPage(c) {
  ...
  const body = `
    ...
    <section class="sect" style="background:#fff"><div class="ctn" style="max-width:700px">
      ...
      <form class="rv d2" onsubmit="event.preventDefault();const b=this.querySelector('button');b.innerHTML='Message Sent! &#10003;';b.style.background='#10b981'" style="display:flex;flex-direction:column;gap:20px">
        <div class="mobile-1col" style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
          <div><label style="display:block;font-size:14px;font-weight:600;color:#333;margin-bottom:8px">First Name</label><input type="text" placeholder="John" style="width:100%;padding:14px 18px;border:2px solid #eee;border-radius:12px;font-size:15px;font-family:inherit;transition:all 0.3s;outline:none" onfocus="this.style.borderColor='${pc}';this.style.boxShadow='0 0 0 4px ${pc}15'" onblur="this.style.borderColor='#eee';this.style.boxShadow='none'"></div>
          <div><label style="display:block;font-size:14px;font-weight:600;color:#333;margin-bottom:8px">Last Name</label><input type="text" placeholder="Doe" style="width:100%;padding:14px 18px;border:2px solid #eee;border-radius:12px;font-size:15px;font-family:inherit;transition:all 0.3s;outline:none" onfocus="this.style.borderColor='${pc}';this.style.boxShadow='0 0 0 4px ${pc}15'" onblur="this.style.borderColor='#eee';this.style.boxShadow='none'"></div>
        </div>
        <div><label style="display:block;font-size:14px;font-weight:600;color:#333;margin-bottom:8px">Email</label><input type="email" placeholder="john@example.com" style="width:100%;padding:14px 18px;border:2px solid #eee;border-radius:12px;font-size:15px;font-family:inherit;transition:all 0.3s;outline:none" onfocus="this.style.borderColor='${pc}';this.style.boxShadow='0 0 0 4px ${pc}15'" onblur="this.style.borderColor='#eee';this.style.boxShadow='none'"></div>
        <div><label style="display:block;font-size:14px;font-weight:600;color:#333;margin-bottom:8px">Message</label><textarea rows="5" placeholder="Tell us about your project..." style="width:100%;padding:14px 18px;border:2px solid #eee;border-radius:12px;font-size:15px;font-family:inherit;resize:vertical;transition:all 0.3s;outline:none" onfocus="this.style.borderColor='${pc}';this.style.boxShadow='0 0 0 4px ${pc}15'" onblur="this.style.borderColor='#eee';this.style.boxShadow='none'"></textarea></div>
